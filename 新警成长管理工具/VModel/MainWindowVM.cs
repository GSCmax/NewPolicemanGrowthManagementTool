...
namespace 新警成长管理工具.VModel
{
    internal partial class MainWindowVM : ObservableValidator
    {
        ...
        public string? YearStr => $"""
            ...
            共计新警{GlobalDataHelper.policemanLibrary!.PolicemanList.Count(a => a.PolicemanYear == SelectedYear)}人，其中男性{GlobalDataHelper.policemanLibrary!.PolicemanList.Where(a => a.PolicemanYear == SelectedYear).Count(b => b.PolicemanSex == "男")}人，女性{GlobalDataHelper.policemanLibrary!.PolicemanList.Where(a => a.PolicemanYear == SelectedYear).Count(b => b.PolicemanSex == "女")}人；
            中共党员{GlobalDataHelper.policemanLibrary!.PolicemanList.Where(a => a.PolicemanYear == SelectedYear).Count(b => b.IfCommunist == "是")}人，研究生{GlobalDataHelper.policemanLibrary!.PolicemanList.Where(a => a.PolicemanYear == SelectedYear).Count(b => b.PolicemanDegree == "研究生")}人，本科生{GlobalDataHelper.policemanLibrary!.PolicemanList.Where(a => a.PolicemanYear == SelectedYear).Count(b => b.PolicemanDegree == "本科生")}人；
